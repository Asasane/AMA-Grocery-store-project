...
if(isset($_POST["getProduct"])){
	...
	$product_query = "SELECT * FROM products where product_flag=1";
			...
			echo "
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-heading testp'>$.$pro_price.00";
									echo '<a style="float:right" href="updatecart.php?id='.$row['product_id'].'">Add to Cart</a>';
			echo "				</div>
							</div>
						</div>	
			...
			$no = $no + 1;
				...
				echo "
					<div class='row'>
							...
							<div class='col-md-2 col-sm-2'><input type='text' class='form-control price' pid='$pro_id' id='price-$pro_id' value='$pro_price' name='' disabled></div>
